---
name: seo-geo-audit-checklist
description: Use when users ask for a full SEO/GEO audit, prioritized SEO fixes (P0/P1/P2), on-page/schema review, AI search optimization, or a practical checklist with commands.
---
...
Use this skill to run structured, priority-based diagnosis and deliver actionable fixes.

## Execution Workflow

1. Determine audit target (URL/page/source/text) and page type.
2. Run checks in this order: Technical SEO -> On-Page SEO -> Schema -> GEO -> Off-page/E-E-A-T -> Content strategy -> Monitoring.
3. Categorize findings by priority: `P0` (Critical), `P1` (Important), `P2` (Recommended).
4. If metrics are unavailable (CWV, backlinks, GA/GSC), explicitly ask for them.
5. Deliver concise fixes and next-step validation commands.
...
When generating an audit report, always use this structure:

1. `P0 Critical`
2. `P1 Important`
3. `P2 Recommended`
4. `Quick Wins`
5. `Commands/Tools to verify`
