...
export default function Footer() {
  ...
  <Image alt="OpenHunts Club Member" height={105} src="https://cdn.openhunts.com/badges/club.webp" width={486} />
</a>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/how-to-use" className="hover:text-violet-400 transition-colors">
                  {t('howToUse')}
                </Link>
              </li>
            </ul>
