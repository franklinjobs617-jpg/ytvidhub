          ...
          return (
            ...
            >
              <div
                ...
                ${isActive ? "ring-2 ring-blue-500 shadow-md ring-offset-2 ring-offset-slate-50" : "ring-1 ring-slate-200 hover:ring-slate-300 hover:shadow-sm opacity-60 hover:opacity-100"}
              `}
              >
                <img
                  src={v.thumbnail}
