...
export default function TranscriptGeneratorHero() {
    ...
    const handleGenerateTranscript = async () => {
        ...
        try {
            ...
            router.push(`/workspace?urls=${encodeURIComponent(normalizedUrl)}&from=transcript-generator&mode=download`);
        } finally {
            setTimeout(() => {
                    ...
                    <div className="max-w-4xl mx-auto">
                                    ...
                                    <div className={`relative flex items-center rounded-2xl border bg-white transition-all duration-200 shadow-[inset_0_2px_4px_rgba(0,0,0,0.04)] ${isFocused
                                        ...
                                        <div className="pr-3 pt-3 pb-3 flex-shrink-0">
                                            ...
                                            >
                                                ...
                                                <span className="hidden sm:inline">{t('interface.generate')}</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                            <div className="text-center p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                                ...
                                <div className="text-xs text-slate-500 font-medium">{t('stats.transcripts')}</div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                            ...
                            <div className="text-center p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
                                <div className="text-2xl font-bold text-purple-600 mb-1">99.5%</div>
                                <div className="text-xs text-slate-500 font-medium">{t('stats.accuracy')}</div>
                            </div>
                            <div className="text-center p-4 bg-white rounded-xl border border-slate-100 shadow-sm">
