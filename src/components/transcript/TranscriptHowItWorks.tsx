              ...
              return (
                <div key={index} className="relative">
                  ...
                  <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 relative z-10">
                    ...
                    {/* Step Number */}
                    <div className={`w-8 h-8 rounded-full border-2 flex items-center justify-center text-sm font-bold mb-4 ${getStepColor(step.color)}`}>
                      {index + 1}
                    </div>
                    
                    {/* Icon */}
                    <div className={`w-12 h-12 rounded-xl border flex items-center justify-center mb-4 ${getColorClasses(step.color)}`}>
                      <Icon size={24} />
                    </div>
