...
export default function CustomCreditSlider({
  ...
  const handlePurchase = async () => {
    ...
    setLoading(true);
    trackConversion("credit_purchase_click", {
      quantity,
      price: Number(price),
    });
          ...
          <div className="flex-1 w-full lg:border-l lg:border-r border-slate-200 lg:px-12 py-2">
            ...
            <div className="flex items-end justify-between mb-8">
              ...
              <div className="text-right">
                ...
                <div className="text-4xl font-black text-blue-600 tracking-tighter leading-none">
                  ${price}
                </div>
              </div>
            </div>
            ...
            <div className="relative w-full h-8 flex items-center group mb-2">
              ...
              >
                <div
                  className={`w-2 h-2 rounded-full bg-blue-600 transition-opacity duration-200 ${isDragging ? "opacity-100" : "opacity-0"}`}
                />
              </div>
            </div>
