...
export default function PaymentChoiceModal({ isOpen, onClose, selectedPlanId }: PaymentChoiceModalProps) {
          ...
          >
            {loading ? (
              ...
              <>
                ...
                <span className="text-sm font-semibold text-slate-700">Pay with Credit Card</span>
              </>
            )}
          </button>
