              ...
              <div className="flex-1 min-w-0 text-left">
                <h4
                  className={`text-[11px] font-bold truncate ${
                    activeVideoId === v.id ? "text-blue-600" : "text-slate-500"
                  }`}
                >
                  {v.title}
                </h4>
            ...
            <div className="px-6 py-3 bg-white border-b border-slate-200 flex items-center justify-between sticky top-0 z-20">
              <div className="flex items-center gap-4">
                ...
                <nav className="flex items-center gap-4">
                  <button className="text-[10px] font-black text-blue-600 uppercase border-b-2 border-blue-600 pb-1">
                    {t("summary")}
                  </button>
                </nav>
              </div>
