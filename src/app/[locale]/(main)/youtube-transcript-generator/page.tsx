            ...
            <div className="rounded-xl border border-blue-100 bg-blue-50/50 p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              <div className="flex-1">
                <p className="text-sm font-semibold text-slate-800">
                  Need to download transcripts from a full playlist?
                </p>
                <p className="text-xs text-slate-500 mt-0.5">
                  The transcript downloader supports bulk export from entire playlists and channels — all files in one ZIP.
                </p>
              </div>
              <Link
