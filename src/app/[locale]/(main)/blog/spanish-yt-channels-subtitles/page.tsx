...
export default function SpanishYTChannelsBlogPage() {
  ...
  const channels = [
    ...
    },
    {
      ...
      desc: "High-energy travel vlogs. Perfect for advanced learners practicing fast, natural speech.",
      icon: "✈️",
    },
    {
      title: "La Cocina de Elena",
      desc: "Learn everyday vocabulary and cooking terms with authentic Spanish recipes.",
      icon: "🍳",
    },
    {
      title: "Draw My Life en Español",
      desc: "Simple, engaging narratives with visuals that aid comprehension.",
      icon: "✏️",
    },
    {
      title: "Curiosamente",
      desc: "Animated educational videos, great for expanding specific vocabulary sets.",
      icon: "💡",
    },
    {
      title: "Noticias Telemundo",
      desc: "Formal, broadcast-quality Spanish news reports for advanced learners.",
      icon: "📰",
    },
    {
      title: "EnchufeTV",
      desc: "Comedy sketches for picking up modern slang and fast-paced dialogue.",
      icon: "🎭",
    },
    {
      title: "BookBox Spanish",
      desc: "Animated children's stories with perfectly synced subtitles, ideal for beginners.",
      icon: "📚",
    },
    {
      title: "TED en Español",
      desc: "Inspiring talks providing exposure to academic and professional language.",
      icon: "🎤",
    },
  ];
  return (
      ...
      <main className="editorial-main">
        ...
        <header className="article-shell article-hero">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            We've curated the best YouTube channels with reliable subtitles,
        ...
        <article className="article-shell article-section">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            Each channel consistently provides high-quality Spanish subtitles,
            making them ideal for vocabulary extraction.
          </p>
        ...
        <article className="article-shell article-section">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            ...
            Here&apos;s how to turn any video into a powerful study tool.
          </p>
          <ol className="space-y-6 mb-8">
            {[
              {
                title: "Download Subtitles",
                desc: "Paste the URL into YTVidHub and select 'Clean TXT' format to get a pure text file without timestamps.",
              },
              {
                title: "Identify Vocabulary",
                desc: "Read through the transcript and copy interesting sentences or idiomatic expressions you want to master.",
              },
              {
                title: "Create Anki Cards",
                desc: "Paste the Spanish sentence on the front and its translation on the back. Review daily for rapid growth.",
              },
            ].map((step, i) => (
        ...
        <section className="article-shell article-section text-center">
          <div className="rounded-2xl bg-slate-900 p-12 md:p-16">
            ...
            <p className="text-slate-400 mb-8">
              Extract subtitles from an entire channel&apos;s playlist for
              vocabulary mining with our bulk downloader.
            </p>
            <Link
