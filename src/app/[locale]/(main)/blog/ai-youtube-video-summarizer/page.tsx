      ...
      <main className="max-w-6xl mx-auto px-6 py-12 md:py-10">
        <header className="text-center mb-24 md:mb-32">
          ...
          <h1 className="text-4xl md:text-7xl font-display font-black uppercase tracking-tight text-slate-900 mb-8 leading-[1.1]">
            Decode Videos <br />
            <span className="text-violet-600">With Intelligence.</span>
          </h1>
          ...
          <div className="grid md:grid-cols-12 gap-12 items-start">
            <div className="md:col-span-5">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 italic">
                  AI-Powered Study Insights
                </h2>
              </div>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                Our <strong>AI YouTube summarizer</strong> uses advanced
                reasoning to extract the core value of any video. Stop skimming
                through hours of footage—get the facts instantly.
              </p>
              <Link
                href="/"
                className="inline-flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-violet-600 transition-all group shadow-2xl shadow-slate-200 uppercase tracking-widest text-xs"
              >
                Launch AI Summary{" "}
                <ChevronRight
                  size={18}
            ...
            <div className="md:col-span-7 grid sm:grid-cols-2 gap-8">
              {[
                ...
                {
                  title: "Deep Insights",
                  desc: "Summaries that understand context, tone, and the 'Why' behind the content.",
                  icon: <Brain />,
                },
                {
                  title: "Knowledge Sync",
                  desc: "One-click export to your digital garden: Notion, Obsidian, or Markdown.",
                  icon: <CheckCircle2 />,
                },
                {
                  title: "Language Support",
                  desc: "Supports summarizing YouTube videos in 50+ languages seamlessly.",
                  icon: <Sparkles />,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-6 bg-white rounded-3xl border border-slate-100 shadow-sm transition-transform hover:-translate-y-1"
                >
        ...
        <section className="mb-40 py-24 bg-white rounded-[4rem] border border-slate-200 shadow-sm px-8 md:px-12 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-8 italic tracking-tighter uppercase">
              Smart Transcripts for Professional Research
            </h2>
            <p className="text-xl text-slate-600 mb-12 leading-relaxed">
              Why settle for messy, unorganized captions? YTVidHub converts raw{" "}
              <strong>YouTube video transcripts to text</strong> with semantic
              grouping, making them perfect for{" "}
              <strong>LLM training datasets</strong> or deep-dive content
              analysis.
            </p>

            <div className="grid sm:grid-cols-2 gap-8 text-left">
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                <h4 className="font-black text-blue-600 text-xs uppercase tracking-[0.2em] mb-4">
                  Search Capability
                </h4>
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Instantly locate any word across hours of video footage. One
                  click takes you to the exact timestamp in the original video.
                </p>
              </div>
              <div className="p-8 bg-slate-50 rounded-[2rem] border border-slate-100">
                <h4 className="font-black text-blue-600 text-xs uppercase tracking-[0.2em] mb-4">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  We group related sentences into logical paragraphs, preserving
                  the speaker's flow and making the content easy to digest.
                </p>
              </div>
            </div>
          </div>
          ...
          {[
            {
              ...
              desc: "Build clean, noise-free text corpora from YouTube channels for AI fine-tuning.",
            },
            {
              icon: <Video />,
              title: "Content Creators",
              desc: "Turn any video into an SEO-optimized blog post with one click using AI summaries.",
            },
            {
              icon: <Zap />,
            ...
            <div
              key={i}
              className="group p-10 bg-white rounded-[3rem] border border-slate-100 shadow-sm hover:shadow-2xl transition-all text-center"
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-4 uppercase italic tracking-tighter">
                {box.title}
              </h3>
              <p className="text-slate-500 text-sm leading-relaxed">
                {box.desc}
        ...
        <section className="mb-40 max-w-4xl mx-auto">
          <h2 className="text-2xl font-black text-slate-900 mb-12 uppercase tracking-[0.4em] text-center italic">
            Industry Q&A
          </h2>
          <div className="grid gap-6">
            {[
              ...
              },
              {
                ...
                a: "Yes. Our tool is optimized to provide 'Clean TXT' exports, which strip out music cues and artifacts, leaving you with a pristine text dataset.",
              },
              {
                q: "Does YTVidHub support YouTube playlist summaries?",
                a: "Combined with our Bulk Downloader, you can process entire playlists and generate summaries for multiple videos at once.",
              },
            ].map((faq, i) => (
              <div
                key={i}
                className="p-8 bg-white rounded-3xl border border-slate-200 hover:border-violet-400 transition-colors shadow-sm flex gap-6"
              >
                <div className="font-black text-violet-200 text-4xl leading-none">
                  0{i + 1}
                </div>
                <div>
        ...
        <section className="bg-slate-900 rounded-[5rem] p-16 md:p-24 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-7xl font-black mb-10 leading-tight italic uppercase tracking-tighter">
              Own the <br />
              Knowledge.
            </h2>
            <p className="text-slate-400 mb-16 text-xl">
              Don't just watch videos. Master them with YTVidHub AI
              Intelligence.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/"
                className="px-14 py-5 bg-violet-600 hover:bg-violet-700 rounded-3xl font-bold transition-all shadow-2xl shadow-violet-600/30"
              >
                Try AI Summary Free
              </Link>
            </div>
