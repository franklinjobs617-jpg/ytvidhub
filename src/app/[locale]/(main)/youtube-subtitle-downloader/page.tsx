                ...
                <section className="bg-gradient-to-br from-blue-50 via-white to-indigo-50 relative overflow-hidden">
                    ...
                    <div className="relative pt-16 pb-20 text-center px-6 z-10">
                        ...
                        <p className="text-xl text-slate-600 max-w-3xl mx-auto font-medium mb-8 leading-relaxed">
                            Extract <strong>YouTube captions</strong> in SRT, VTT, and TXT formats instantly. This page is optimized for subtitle and caption download workflows, especially timing-based formats like SRT and VTT.
                        </p>
                ...
                <section className="py-16 bg-slate-50">
                    <div className="container mx-auto px-6 max-w-4xl">
                        ...
                        <div className="grid md:grid-cols-3 gap-5">
                            <Link href="/youtube-subtitle-downloader" className="block p-5 rounded-xl border border-blue-200 bg-blue-50 hover:shadow-sm transition-shadow">
                                <h3 className="font-bold text-slate-900 mb-2">Subtitle Downloader</h3>
                                <p className="text-sm text-slate-600">Best for SRT/VTT caption download and editing workflows.</p>
                            </Link>
                            <Link href="/extract-youtube-subtitles-online-tool" className="block p-5 rounded-xl border border-slate-200 bg-white hover:shadow-sm transition-shadow">
                                <h3 className="font-bold text-slate-900 mb-2">Subtitle Extractor</h3>
                                <p className="text-sm text-slate-600">Best for online extraction flow, quick checks, and format selection.</p>
                            </Link>
                            <Link href="/download-youtube-transcript-as-text" className="block p-5 rounded-xl border border-slate-200 bg-white hover:shadow-sm transition-shadow">
                                <h3 className="font-bold text-slate-900 mb-2">Transcript as Text</h3>
                                <p className="text-sm text-slate-600">Best for clean no-timestamp TXT output for AI and notes.</p>
                            </Link>
                        </div>
                    </div>
                </section>
