      ...
      <main>
        ...
        <header className="max-w-3xl mx-auto px-6 pt-16 pb-12 md:pt-24 md:pb-16 article-shell article-hero">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            We build tools that respect your time, simplify your data workflow,
            and empower your research.
          </p>
        </header>
        {/* Mission */}
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-4 text-lg text-slate-600 leading-relaxed mb-8">
            <p>
              YTVidHub was born from a simple frustration: downloading subtitles
              from multiple YouTube videos was a slow, repetitive, and
              inefficient process.
            </p>
            <p className="italic font-medium text-slate-900">
              &quot;As researchers and creators, we spent countless hours
              copying files one by one. We knew there had to be a better
              way.&quot;
            </p>
            <p>
        ...
        <section className="max-w-3xl mx-auto px-6 mb-16 text-center">
          <div className="rounded-2xl bg-slate-900 p-12 md:p-16">
            ...
            <p className="text-slate-400 mb-8">
              Have a question, feedback, or a feature request? Our team is ready
              to listen.
            </p>
            <a
