      ...
      <main>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-12 article-shell article-section">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            your information. Our guiding rule is simple: we collect the
            absolute minimum amount of information required, and we have
            architected our system to be
        ...
        <article className="max-w-3xl mx-auto px-6 mb-12 article-shell article-section">
          ...
          <p className="text-slate-600 leading-relaxed mb-6">
            Our service is built to be stateless. We explicitly DO NOT collect
            or store:
          </p>
          <div className="space-y-5">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Your IP address is not logged or stored on our servers in
            ...
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                The YouTube video URLs you paste are used in real-time and are
                immediately discarded. They are never written to any database.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              <h3 className="font-semibold text-slate-900 mb-1">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Subtitle files are generated on-the-fly and streamed directly to
                you. They never touch our physical hard drives.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              <h3 className="font-semibold text-slate-900 mb-1">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                We do not have an account system for free users. We do not ask
                for or store your name or email address.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-12 article-shell article-section">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            Referrer Information, and Browser Type.
          </p>
        </article>
        {/* 4. Cookies */}
        <article className="max-w-3xl mx-auto px-6 mb-12 article-shell article-section">
