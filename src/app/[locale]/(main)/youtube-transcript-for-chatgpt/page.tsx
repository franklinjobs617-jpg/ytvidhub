      ...
      <main>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <p className="text-slate-500 mb-8">
            ChatGPT can&apos;t watch videos — but it can read transcripts.
            Here&apos;s how.
          </p>
          <div className="space-y-5">
            ...
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Open any YouTube video and copy the URL from your browser.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Paste the URL here, select TXT format, and click Extract. Get a
                clean transcript with no timestamps.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Copy the transcript and paste it into ChatGPT with your prompt.
                Done.
              </p>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            ...
            {[
              ...
              >
                ...
                <code className="text-xs bg-white text-slate-600 px-3 py-1.5 rounded-lg border border-slate-100 block">
                  {item.prompt}
                </code>
              </div>
            ))}
        ...
        <section className="max-w-3xl mx-auto px-6 mb-16 text-center">
          ...
          <div className="rounded-2xl bg-slate-900 p-12 md:p-16">
            ...
            <p className="text-slate-400 mb-8">
              Free, instant, no account required. Works on any YouTube video.
            </p>
            <Link
              href="/"
              className="inline-block px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-colors"
