          ...
          <div className="space-y-5">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              <h3 className="font-semibold text-slate-900 mb-2">
                Is YTVidHub completely free to use?
              </h3>
            ...
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                No registration is required for basic use. YTVidHub is designed
                to be as simple as possible. Just visit our site, paste your
                URL(s), and download your files instantly within the free daily
                limit.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Downloading publicly available subtitles for personal use, such
                as for accessibility, language learning, or research, generally
                falls under fair use. However, you should always respect the
                copyright of the content creator.
              </p>
            </div>
          </div>
        </article>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-5">
            ...
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                To download subtitles from multiple videos at once, paste each
                YouTube URL on a new line in the input box. Our tool will
                process all of them and package the files into a single,
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-5">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                This means the video either doesn&apos;t have manual subtitles
                uploaded by the creator, or the owner has disabled subtitle
                access. Our tool can only retrieve publicly available caption
                tracks.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                First, double-check that the URL is a valid YouTube link. Then
                try clearing your browser cache, disabling any ad-blockers, and
                refreshing the page. Also ensure you haven&apos;t exceeded your
                free daily credit limit.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              <h3 className="font-semibold text-slate-900 mb-2">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                No. YTVidHub can only access subtitles from publicly available
                YouTube content. Private, unlisted, or age-restricted videos are
                not supported.
              </p>
            </div>
          </div>
