      ...
      <main>
        ...
        <header className="max-w-3xl mx-auto px-6 pt-16 pb-12 md:pt-24 md:pb-16 article-shell article-hero">
          ...
          <p className="text-lg text-slate-500 leading-relaxed mb-8">
            Need a fast YouTube transcript download workflow? Paste any video
            URL and download YouTube transcript files as TXT, SRT, or VTT for AI
            training, research, and editing.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              ...
              className="inline-block px-8 py-3 bg-white hover:bg-slate-50 text-slate-700 rounded-lg font-medium border border-slate-200 transition-colors"
            >
              Bulk Processing
            </Link>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Our cloud-based architecture processes YouTube API data in
                real-time. No browser-side rendering delay—extract hour-long
                videos in seconds.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Fully compatible with YouTube&apos;s multi-language tracks. From
                manually uploaded files to AI auto-generated captions, we
                capture them all.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Unlike traditional downloader sites, YTVidHub is clean, secure,
                and entirely ad-free. We focus on high-performance tools and
                data privacy.
              </p>
            </div>
          </div>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <p className="text-slate-500 mb-8">
            Select the optimal standard for your specific workflow.
          </p>
          <div className="grid sm:grid-cols-2 gap-5 mb-8">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed mb-3">
                The most universal format. Supported by VLC, Premiere Pro, Final
                Cut, and almost every video player and editor.
              </p>
            ...
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed mb-3">
                Defined by the WebVTT standard. Purpose-built for HTML5 players
                with support for styling and positioning tags.
              </p>
              <ul className="space-y-1 text-xs text-slate-500">
          ...
          <div className="p-6 rounded-xl border border-blue-200 bg-blue-50">
            <p className="text-xs text-blue-600 font-medium uppercase tracking-wider mb-2">
              AI Ready — Plain Text (TXT)
            </p>
            <p className="text-sm text-slate-700 font-medium leading-relaxed mb-3">
              Automatically strips all timestamps and metadata. Export a clean
              text stream, perfect for ChatGPT summarization, RAG pipelines, or
              blog drafting.
            </p>
            <Link
              href="/workspace"
            ...
            {[
              {
                ...
                desc: "Copy the URL from YouTube's address bar and paste it into our search tool.",
              },
              {
                step: "Step 2",
                title: "Select Format",
                desc: "Choose your preferred language track and output format (SRT, VTT, or TXT).",
              },
              {
                step: "Step 3",
                title: "Instant Download",
                desc: "Click high-speed download and your subtitle file is saved to your local drive instantly.",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <section className="max-w-3xl mx-auto px-6 mb-16 text-center">
          <div className="rounded-2xl bg-slate-900 p-12 md:p-16">
            ...
            <p className="text-slate-400 mb-8">
              Join thousands of creators and researchers. No registration
              required, free limits available forever.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/pricing"
                className="inline-block px-8 py-3 bg-white/10 hover:bg-white/20 text-white rounded-lg font-medium border border-white/20 transition-colors"
              >
                View Pro Plans
              </Link>
            </div>
