    ...
    <div className="bg-white min-h-screen font-sans antialiased text-slate-700">
      ...
      <main>
        <header className="max-w-3xl mx-auto px-6 pt-16 pb-12 md:pt-24 md:pb-16">
          <p className="text-sm text-blue-600 font-medium mb-4">Transcript Workflow Guide</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-200 bg-slate-50">
                  <th className="py-3 px-4 text-left font-semibold text-slate-900">Format</th>
                  <th className="py-3 px-4 text-left font-semibold text-slate-900">Best For</th>
                </tr>
              </thead>
              <tbody className="text-slate-600">
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 font-medium text-slate-900">TXT</td>
                  <td className="py-3 px-4">AI prompts, RAG, note-taking, summarization</td>
                </tr>
                <tr className="border-b border-slate-100">
                  <td className="py-3 px-4 font-medium text-slate-900">SRT</td>
                  <td className="py-3 px-4">Video editing and subtitle timing workflows</td>
                </tr>
                <tr>
                  <td className="py-3 px-4 font-medium text-slate-900">VTT</td>
                  <td className="py-3 px-4">Web players and browser subtitle rendering</td>
                </tr>
              </tbody>
            </table>
          </div>
