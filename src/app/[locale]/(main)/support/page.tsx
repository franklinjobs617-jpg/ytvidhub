  ...
  return (
    <div className="bg-white min-h-screen antialiased text-slate-700 article-body">
      ...
      <main>
        ...
        {/* Contact */}
        <article className="max-w-3xl mx-auto px-6 mb-16 text-center article-shell article-section">
          ...
          <div className="p-8 rounded-2xl border border-slate-200 bg-slate-50 mb-4">
            ...
            <a
              ...
              className="text-2xl md:text-3xl font-bold text-slate-900 hover:text-blue-600 transition-colors"
            >
            ...
            {[
              ...
              >
                ...
                <p className="text-sm text-slate-500 leading-relaxed mb-3">
                  {t(`categories.${item.key}.description`)}
                </p>
                <div className="space-y-1">
                  
                  {[1, 2, 3, 4].map((j) => (
                    <p key={j} className="text-xs text-slate-400">
                      · {t(`categories.${item.key}.topic${j}`)}
                    </p>
                  ))}
                </div>
              </div>
        ...
        <section className="max-w-3xl mx-auto px-6 mb-16 text-center">
          ...
          <Link
            href="/faq"
            className="inline-block px-8 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-lg font-medium transition-colors"
          >
