      ...
      <main>
        ...
        <header className="max-w-3xl mx-auto px-6 pt-16 pb-12 md:pt-24 md:pb-16 article-shell article-hero">
          ...
          <p className="text-lg text-slate-500 leading-relaxed">
            ...
            If you&apos;re reading this, you&apos;re past the point of casual
            YouTube viewing. You understand that video subtitles are not just
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            ...
            The standard WebVTT (<code>.vtt</code>) file downloaded from most
            sources is toxic to a clean database. It contains layers of
            metadata, timecodes, and ASR noise markers that destroy the purity
          ...
          <div className="rounded-xl bg-slate-900 p-6 mb-8 overflow-x-auto">
            ...
            <pre className="font-mono text-sm text-blue-300 leading-relaxed">
              ...
              <code>{`WEBVTT Kind: captions Language: en 1:23.456 --> 1:25.789 align:start position:50% [Music] 1:26.001 --> 1:28.112 >> Researcher: Welcome to the data hygiene`}</code>
            </pre>
          </div>
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            
            Your time is the most expensive variable in this equation. If you
            are still writing regex scripts to scrub this debris, your
          ...
          <div className="p-5 rounded-xl border border-blue-100 bg-blue-50 mb-8">
            ...
            <p className="text-sm text-blue-800 leading-relaxed italic">
              ...
              required 5.1s per file for scrubbing. YTVidHub&apos;s clean output
              dropped this to 0.3s—a 17x throughput gain allowing for datasets
              5x larger in the same timeframe.&quot;
            </p>
          </div>
              ...
              <tbody className="text-slate-600">
                ...
                <tr className="border-b border-slate-100">
                  ...
                  <td className="py-3 px-4">
                    Timecode + <strong>Optional Metadata</strong>
                  </td>
                </tr>
                <tr className="border-b border-slate-100">
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            ...
            Your research project requires not one VTT file, but one hundred.
            This is where the YouTube Data API becomes a catastrophic workflow
            bottleneck.
          </p>
          <div className="p-5 rounded-xl border border-blue-200 bg-blue-50 mb-8">
            ...
            <p className="text-sm text-blue-700 leading-relaxed italic">
              ...
              &quot;Relying on the official API for bulk acquisition is a flawed
              O(N²) solution. You pay quota dollars per request AND pay
              developers to write scrubbing scripts that YTVidHub performs
              internally for free.&quot;
            </p>
          </div>
          <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
