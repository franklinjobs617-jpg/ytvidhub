        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-4 text-lg text-slate-600 leading-relaxed mb-8">
            <p>
              ...
              guide is for those who need
              <strong>advanced YouTube Subtitle Data Preparation</strong>—the
              tools and methods to convert noise into clean, structured data
            ...
            <p>
              ...
              toolkit centers around resolving this efficiency bottleneck.
            </p>
          </div>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-5 mb-8">
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Input the playlist URL. Our tool queues every video in the list
                automatically, harvesting links recursively.
              </p>
            </div>
            <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
              <h4 className="font-semibold text-slate-900 mb-1">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Developers demand structured data. We offer
                <strong>JSON export</strong> with segment IDs, acting as a free
                API alternative.
              </p>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: "Switch to playlist/channel ingestion mode.",
              },
              {
                title: "JSON Selection",
                desc: "Choose structured fields to bypass parsing scripts.",
              },
              {
                title: "ZIP Packing",
                desc: "Initiate archive for massive dataset portability.",
              },
            ].map((step, i) => (
                ...
                {[
                  {
                    ...
                    desc: "Saved $500/mo on API costs",
                  },
                  {
                    val: "5min",
                    label: "vs 3hrs",
                    desc: "100-video playlist automation",
                  },
                  {
                    val: "95%",
                    label: "Automated",
                    desc: "Minimized manual work",
                  },
                ].map((item, i) => (
                  <div key={i}>
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-4 text-lg text-slate-600 leading-relaxed mb-8">
            ...
            <p>
              ...
              <strong>
                Our core value is providing the clean input that makes AI tools
                actually useful.
              </strong>
            </p>
          </div>
