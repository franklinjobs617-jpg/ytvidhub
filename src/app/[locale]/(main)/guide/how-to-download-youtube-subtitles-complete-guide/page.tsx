...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Download YouTube subtitles instantly — no software, no login. Paste any YouTube URL and get SRT/VTT/TXT files in seconds. Works for single videos, playlists & bulk. 100% free.",
    keywords:
      "how to download youtube subtitles, download youtube captions, extract youtube subtitles, youtube subtitle downloader, batch download youtube subtitles",
    openGraph: {
      title:
        "How to Download YouTube Subtitles Free in Seconds (2026) — SRT, VTT, TXT",
      description:
  ...
  const structuredData = [
    {
      ...
      description:
        "Complete guide on downloading YouTube subtitles using multiple methods including manual extraction and automated tools",
      ...
      <main>
            ...
            <table className="w-full text-sm">
              ...
              <thead>
                ...
                <tr className="border-b border-slate-200 bg-slate-50">
                  ...
                  <th className="py-3 px-4 text-center font-semibold text-slate-900">
                    Difficulty
                  </th>
                  <th className="py-3 px-4 text-center font-semibold text-slate-900">
                    Time
        ...
        <article id="method-2" className="max-w-3xl mx-auto px-6 mb-16">
            ...
            {[
              {
                ...
                desc: "Download subtitles from entire playlists and channels at once",
              },
              {
                title: "Professional Formats",
                desc: "Export as SRT, VTT, or clean TXT files ready for any use case",
              },
              {
                title: "Lightning Fast",
                desc: "Process videos in seconds, not minutes",
              },
              {
              ...
              },
              {
                ...
                desc: "5 free downloads daily, no credit card required",
              },
              {
                title: "All Languages Supported",
                desc: "Works with any language available on YouTube",
              },
            ].map((item, i) => (
              <div
                key={i}
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-slate-400 mt-3">
              5 free downloads daily · No registration required
            </p>
          </div>
        </article>
            ...
            {[
              {
                ...
                desc: 'Navigate to the YouTube video you want to extract subtitles from. Make sure the video has captions available (you\'ll see a "CC" button in the video player).',
              },
              {
              ...
              },
              {
                ...
                desc: 'From the dropdown menu, click on "Show transcript". This will open a panel on the right side displaying the video\'s transcript with timestamps.',
              },
              {
                title: "Copy the Transcript",
                desc: "Select all the text in the transcript panel (Ctrl+A or Cmd+A), then copy it (Ctrl+C or Cmd+C).",
              },
              {
                title: "Save and Format",
                desc: "Paste the transcript into a text editor. You may need to clean up the formatting and remove timestamps if desired.",
              },
            ].map((step, i) => (
            ...
            {[
              {
                ...
                desc: 'Search for subtitle downloader extensions in your browser\'s extension store. Popular options include "YouTube Subtitle Downloader" extensions.',
              },
              {
                title: "Navigate to YouTube Video",
                desc: "Go to the YouTube video page. The extension should add a download button or menu option to the page.",
              },
              {
                title: "Click the Extension Button",
                desc: "Look for the extension's download button near the video player or in the browser toolbar.",
              },
              {
                title: "Choose Format and Download",
                desc: "Select your preferred subtitle format (if available) and click download.",
              },
            ].map((step, i) => (
              <li key={i} className="flex gap-4">
            ...
            {[
              {
                ...
                desc: "Research teams use our bulk downloader to create massive text datasets. The clean TXT format removes timestamps and formatting, making it perfect for LLM training.",
                tip: "Best Format: TXT · Recommended: Bulk processing",
              },
              {
                title: "Video Production & Editing",
                desc: "Content creators and video editors use SRT files to add professional captions to their videos. The timestamp precision is crucial for sync accuracy.",
                tip: "Best Format: SRT · Recommended: Single video downloads",
              },
              {
                title: "Accessibility & Compliance",
                desc: "Organizations download subtitles to ensure their video content meets accessibility standards (WCAG 2.1). VTT format works best for web players.",
                tip: "Best Format: VTT · Recommended: Quality over quantity",
              },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <article className="max-w-3xl mx-auto px-6 mb-16 article-shell article-section">
          ...
          <div className="space-y-5">
            ...
            {[
              {
                title: "SRT Format",
                desc: "The most popular subtitle format, supported by virtually all video players and editing software.",
                points: [
              ...
              {
                title: "VTT Format",
                desc: "Modern web format with advanced styling capabilities, perfect for online video players.",
                points: [
                  "Web-optimized",
                  "Styling support",
                  "HTML5 compatible",
              ...
              {
                title: "TXT Format",
                desc: "Clean plain text without timestamps, ideal for AI training and text analysis.",
                points: [
                  "Clean text only",
                  "AI training ready",
                  "Easy to process",
            ...
            {[
              {
                ...
                a: "Yes! You can download YouTube subtitles for free using YouTube's built-in transcript feature or our YTVidHub tool. We offer 5 free downloads daily with no registration required.",
              },
              {
                q: "What subtitle formats can I download?",
                a: "Our tool supports SRT (SubRip), VTT (WebVTT), and clean TXT formats. SRT is perfect for video editing, VTT for web players, and TXT for AI training and text analysis.",
              },
              {
                q: "Can I batch download subtitles from YouTube playlists?",
                a: "Yes! Our batch YouTube subtitle downloader can extract subtitles from entire playlists and channels at once. This is perfect for creating large datasets for AI training or research projects.",
              },
              {
                q: "Does this work with different languages?",
                a: "Absolutely! Our tool can download subtitles in any language available on the YouTube video, including auto-generated captions and manually uploaded subtitles.",
              },
              {
