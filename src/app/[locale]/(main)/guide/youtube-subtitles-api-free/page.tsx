            ...
            {[
              {
                ...
                desc: "Every captions.download call costs 200 quota units. With a daily limit of 10,000 units, you can only fetch ~50 subtitle files per day before hitting the wall.",
              },
              {
                title: "Complex OAuth Setup",
                desc: "Downloading captions requires OAuth 2.0 user authorization—not just an API key. This adds significant development overhead for a simple text extraction task.",
              },
              {
                title: "Aggressive Rate Limiting",
                desc: "Burst requests trigger 403 errors and temporary bans. Bulk extraction of 1,000+ videos becomes a multi-day, error-prone process.",
              },
            ].map((item, i) => (
              <div
                key={i}
            ...
            {[
              {
                ...
                desc: "Get subtitle data as clean JSON with segment IDs, timestamps, and text fields—ready for direct injection into vector databases or LLM prompt chains.",
              },
              {
                title: "Built for Bulk Ingestion",
                desc: "Paste a playlist or channel URL and extract subtitles from hundreds of videos in a single operation. No rate limits, no 403 errors.",
              },
              {
                title: "Guaranteed Clean Data",
                desc: "Every export runs through our normalization pipeline: BOM stripping, ASR noise removal, and timestamp standardization included by default.",
              },
            ].map((item, i) => (
              <div
                key={i}
