                ...
                <article className="max-w-3xl article-shell article-section">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        <p className="text-slate-700 leading-relaxed mb-4">
                          ...
                          It&apos;s the universal standard for video subtitles,
                          supported by every major video player from VLC to
                          YouTube. You can
                          <Link
                            href="/"
                  ...
                  <section id="anatomy" className="scroll-mt-32 mb-16">
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      {[
                        {
                          t: "Sequence Number",
                          d: "A sequential numeric identifier starting at 1. Must increment by 1 for each subtitle block.",
                          code: "1",
                        ...
                        },
                        {
                          ...
                          tip: "SRT uses commas, VTT uses dots for milliseconds",
                        },
                        {
                          t: "Subtitle Text Content",
                          d: "The actual caption text. Can span multiple lines (max 2 recommended). Supports basic HTML tags like <b>, <i>, <u>.",
                        ...
                        },
                        {
                          ...
                          d: "A mandatory empty line that signals the end of one subtitle block and the beginning of the next.",
                          code: "(blank line)",
                  ...
                  <section id="interactive" className="scroll-mt-32 mb-16">
                    ...
                    <p className="text-slate-500 mb-8">
                      ...
                      <strong>SRT file structure</strong>. Each element follows
                    ...
                    <div className="bg-slate-900 rounded-2xl p-6 md:p-10 font-mono text-sm leading-loose">
                      ...
                      <div className="mt-6 pt-4 border-t border-slate-800 text-xs text-slate-500 space-y-1">
                        ...
                        <p>
                          <strong>Line Endings:</strong> Use CRLF (Windows) or
                          LF (Unix) consistently
                        </p>
                        <p>
                          <strong>Validation:</strong> Our bulk downloader
                          checks all formatting rules
                        </p>
                      </div>
                    </div>
                  </section>
                      ...
                      {[
                        {
                          ...
                          desc: "SRT files support limited HTML for text formatting. Use <b>, <i>, <u> tags for emphasis, but avoid complex CSS.",
                          example: "<b>Important</b>: This text is bold",
                          note: "Not all players support HTML tags",
                        },
                        {
                          title: "Positioning & Alignment",
                          desc: "While basic SRT doesn't support positioning, some players accept positional hints in the timestamp line.",
                          example:
                        ...
                        },
                        {
                          ...
                          desc: "UTF-8 encoding supports all languages. Always include language metadata in filename or header comments.",
                          example:
                        ...
                        },
                        {
                          ...
                          desc: "Optimal readability: max 42 characters per line, 2 lines max. Break at natural phrase boundaries.",
                          example:
                        ...
                        <div className="bg-slate-900 text-white rounded-xl p-6">
                          <ol className="space-y-4 text-sm">
                            <li className="flex items-center gap-3">
                              ...
                              Upload multiple SRT files or paste YouTube URLs
                            </li>
                            <li className="flex items-center gap-3">
                              <span className="bg-blue-600 w-6 h-6 rounded-full flex items-center justify-center text-xs shrink-0">
                                2
                    ...
                    <div className="p-6 rounded-xl border border-blue-200 bg-blue-50 flex flex-col sm:flex-row items-center gap-6">
                      <div className="flex-grow">
                        ...
                        <p className="text-sm text-slate-500">
                          ...
                          provides perfectly formatted
                          <strong>SRT files</strong> from any YouTube playlist
                          or channel.
                        </p>
                      </div>
                      <SrtCtaBulk />
                  ...
                  <section id="ai-use-cases" className="scroll-mt-32 mb-16">
                    ...
                    <div className="p-6 rounded-xl border border-blue-200 bg-blue-50 mb-8">
                      ...
                      <p className="text-sm text-slate-600 mb-4">
                        The .srt subtitle format provides clean, structured text
                        data that is ideal for machine learning models. Its
                        simple structure makes it easy to parse and convert to
                        training datasets for natural language processing and
                    ...
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div className="p-5 rounded-xl border border-slate-100 bg-slate-50">
                        ...
                        <p className="text-sm text-slate-500 leading-relaxed mb-3">
                          SRT&apos;s simple structure makes it ideal for
                          creating clean dialogue datasets. The timestamp-text
                          pairing provides perfect alignment for speech
                          recognition models.
                        </p>
                  ...
                  <section className="text-center rounded-2xl bg-slate-900 p-12 md:p-16">
                    ...
                    <p className="text-slate-400 mb-8 max-w-md mx-auto">
                      Start extracting perfectly formatted SRT files today with
                      our professional bulk downloader. Process unlimited
