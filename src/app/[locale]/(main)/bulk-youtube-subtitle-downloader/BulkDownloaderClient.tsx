                    ...
                    <div className="relative pt-12 pb-16 text-center px-6 z-10">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                            <Link
                                ...
                                className="px-10 py-3.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 transition-all hover:-translate-y-1 text-sm uppercase tracking-widest"
                            >
                                Start Bulk Downloading
                            </Link>
                            <Link
                                href="/pricing"
                                className="px-10 py-3.5 bg-white hover:bg-slate-50 text-slate-700 font-bold rounded-xl border-2 border-slate-100 shadow-sm transition-all hover:-translate-y-1 text-sm uppercase tracking-widest"
                            >
                                View Pricing Plans
                            </Link>
                        </div>
