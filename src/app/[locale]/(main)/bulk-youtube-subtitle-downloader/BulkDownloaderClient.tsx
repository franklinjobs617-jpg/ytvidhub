  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-800 antialiased selection:bg-blue-100">
      ...
      <main className="relative">
        <section className="border-b border-slate-100 bg-[linear-gradient(to_bottom,#f8fafc,white_45%)]">
          <div className="container mx-auto max-w-6xl px-6 pt-16 pb-20">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                <Link
                  href="/pricing"
                  className="rounded-xl border border-slate-200 bg-white px-7 py-3 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50"
                >
                  View Pricing
                </Link>
              </div>
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="mb-3 flex items-center justify-between">
                      <span className="inline-flex items-center gap-2 rounded-md bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600">
                        {item.icon}
                        Step {item.step}
                      </span>
                    </div>
...
Welcome to our deep dive into the future of media...
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-7">
                <p className="text-xs font-semibold uppercase tracking-wide text-indigo-600">For Players & Editing</p>
...
Welcome to our deep dive...
        ...
        <section id="bulk-faq" className="border-y border-slate-200 bg-slate-50 py-20">
