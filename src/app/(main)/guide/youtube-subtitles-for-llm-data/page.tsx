...
import { 
  Database, Zap, ShieldCheck, FileJson, Cpu, 
  ArrowRight, BarChart3, Layers, Filter, CheckCircle2 
} from "lucide-react";
...
export default function LLMTechnicalGuide() {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-indigo-100 text-slate-900 antialiased">
      {/* === SEO & Metadata === */}
      <title>Bulk YouTube Subtitle Extraction for LLM Datasets: The Technical Guide | YTVidHub</title>
      <meta name="description" content="A deep dive into extracting clean, high-signal conversational data from YouTube for Llama-3, GPT-4, and Mistral training. Learn to optimize token efficiency and scale dataset preparation." />
      <link rel="canonical" href="https://ytvidhub.com/guide/bulk-youtube-subtitles-llm-training-data" />
          ...
          <div className="container mx-auto px-6 relative z-10 text-center">
            <div className="mb-8 flex justify-center">
              <div className="flex items-center gap-2 py-2 px-5 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-indigo-300">Technical Documentation v2.0</span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center gap-2 text-xs font-bold text-slate-500 border border-slate-800 px-4 py-2 rounded-lg bg-slate-900/50">
                <CheckCircle2 size={14} className="text-indigo-500" /> GPT-4o Ready
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-500 border border-slate-800 px-4 py-2 rounded-lg bg-slate-900/50">
                <CheckCircle2 size={14} className="text-indigo-500" /> Llama-3 Optimized
              </div>
              <div className="flex items-center gap-2 text-xs font-bold text-slate-500 border border-slate-800 px-4 py-2 rounded-lg bg-slate-900/50">
                <CheckCircle2 size={14} className="text-indigo-500" /> JSONL / Parquet Export
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 lg:px-20">
            ...
            <section className="max-w-4xl mx-auto mb-32">
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-xs font-black text-indigo-600 uppercase tracking-widest">Introduction</span>
                <div className="h-px flex-1 bg-slate-100"></div>
              </div>
                    ...
                    <ul className="space-y-4">
                      {[
                        ...
                        <li key={i} className="flex items-start gap-3 text-sm font-medium text-slate-700">
                          <Zap size={16} className="text-indigo-600 mt-1 shrink-0" /> {text}
                        </li>
                      ))}
                    </ul>
                  </div>
               ...
               <div className="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="order-1 lg:order-2">
                    ...
                    <div className="p-8 bg-indigo-50 rounded-2xl border-l-4 border-indigo-600">
                      <h4 className="font-black text-slate-900 uppercase text-sm mb-2">Researcher Advantage</h4>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                       <div className="p-6 border border-slate-100 rounded-2xl">
                          ...
                          <p className="text-[10px] font-bold uppercase text-slate-400">Token Overhead</p>
                       </div>
                       <div className="p-6 border border-slate-100 rounded-2xl">
                          <Filter className="text-indigo-600 mb-4" size={24} />
                          <p className="text-2xl font-black text-slate-900">99.2%</p>
                          <p className="text-[10px] font-bold uppercase text-slate-400">Signal Accuracy</p>
                       </div>
                    </div>
                  </div>
                  <div>
               ...
               <div className="max-w-4xl mx-auto text-center">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 text-left">
                     <div className="p-8 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 transition-colors">
                        ...
                        <h4 className="text-xl font-bold uppercase mb-4 tracking-tight">Structured JSONL</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">Perfect for OpenAI, Anthropic, or Mistral API fine-tuning. Each video becomes an atomic object with metadata and clean content.</p>
                     </div>
                     <div className="p-8 bg-white/5 border border-white/10 rounded-3xl hover:bg-white/10 transition-colors">
                        <Cpu className="text-indigo-400 mb-6" size={32} />
                        <h4 className="text-xl font-bold uppercase mb-4 tracking-tight">Pure Markdown / TXT</h4>
                        <p className="text-sm text-slate-400 leading-relaxed">Ideal for RAG (Retrieval-Augmented Generation) systems. Native support for chunking and embedding in vector databases like Pinecone or Milvus.</p>
                     </div>
                  </div>
               </div>
            </section>
